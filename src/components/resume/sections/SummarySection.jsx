    ...
    <div className="card p-6 space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-surface-900 dark:text-white font-display">Professional Summary</h3>
        </div>
        <Button variant="outline" size="sm" loading={loading} onClick={handleGenerate} icon={SparklesIcon}>
          AI Generate
        </Button>
      </div>
      ...
      <Textarea
        ...
        rows={5}
        hint={`${summary.length} characters — aim for 100-200`}
      />
    </div>
  );
};
